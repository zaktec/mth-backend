...
VALUES
   (
      'MTH GCSE Maths Foundation',
      'MTH-GF',
      'MTH GCSE Maths Foundation Online Course',
      'Foundation',
      '/course/gcse_foundation.png',
      NULL
   ),
   (
      'MTH GCSE Maths Higher',
      'MTH-HF',
      'MTH GCSE Maths Higher Online Course',
      'Higher',
      '/course/gcse_higher.png',
      NULL
   );
...
INSERT INTO
   digitutor (
      digitutor_quizresult,
      digitutor_usergrade,
      digitutor_targetgrade,
      digitutor_notes,
      digitutor_nextstep,
      digitutor_progressbar,
      digitutor_date
   )
VALUES
...
VALUES
   (
      'Number 1',
      'GFN1',
      'MTH GCSE Maths Online Course - Foundation - Number 1',
      1,
      NULL,
      1
   ),
   (
      'Number 2',
      'GFN2',
      'MTH GCSE Maths Online Course - Foundation - Number 2',
      2,
      NULL,
      1
   ),
   (
      'Algebra 1',
      'GFA1',
      'MTH GCSE Maths Online Course - Foundation - Algebra 1',
      3,
      NULL,
      1
   ),
   (
      'Algebra 2',
      'GFA2',
      'MTH GCSE Maths Online Course - Foundation - Algebra 2',
      4,
      NULL,
      1
   ),
   ...
   (
      'Geometry 1',
      'GFG1',
      'MTH GCSE Maths Online Course - Foundation - Geometry 1',
      6,
      NULL,
      1
   ),
   (
      'Geometry 2',
      'GFG2',
      'MTH GCSE Maths Online Course - Foundation - Geometry 2',
      7,
      NULL,
      1
   ),
   (
      'Probability',
      'GFP1',
      'MTH GCSE Maths Online Course - Foundation - Probability',
      8,
      NULL,
      1
   ),
   (
      'Statistics',
      'GFS1',
      'MTH GCSE Maths Online Course - Foundation - Statistics',
      9,
      NULL,
      1
   ),
   (
      'Number 1',
      'GHN1',
      'MTH GCSE Maths Online Course - Higher - Number 1',
      1,
      NULL,
      2
   ),
   (
      'Number 2',
      'GHN2',
      'MTH GCSE Maths Online Course - Higher  - Number 2',
      2,
      NULL,
      2
   ),
   (
      'Algebra 1',
      'GHA1',
      'MTH GCSE Maths Online Course - Higher  - Algebra 1',
      3,
      NULL,
      2
   ),
   (
      'Algebra 2',
      'GHA2',
      'MTH GCSE Maths Online Course - Higher - Algebra 2',
      4,
      NULL,
      2
   ),
   (
      'Ratio and Measurement',
      'GHRM',
      'MTH GCSE Maths Online Course - Higher  - Ratio and Measurement',
      5,
      NULL,
      2
   ),
   (
      'Geometry 1',
      'GHG1',
      'MTH GCSE Maths Online Course - Higher  - Geometry 1',
      6,
      NULL,
      2
   ),
   (
      'Geometry 2',
      'GHG2',
      'MTH GCSE Maths Online Course - Higher  - Geometry 2',
      7,
      NULL,
      2
   ),
   (
      'Probability',
      'GHP1',
      'MTH GCSE Maths Online Course - Higher - Probability',
      8,
      NULL,
      2
   ),
   (
      'Statistics',
      'GHS1',
      'MTH GCSE Maths Online Course - Higher  - Statistics',
      9,
      NULL,
      2
   );
...
VALUES
   (
      'Addition, Subtraction and Money Problems',
      'GFN1LC1',
   ...
   (
      ...
      'GFN1LC2',
      'To be able to use place value to read and write numbers including decimals.',
      'GFN1WS2',
      'Examples',
      NULL,
      1
   ...
   (
      'Negative Numbers',
      'GFN1LC3',
      'To be able to add, subtract, divide and multiply integer numbers',
      'GFN1WS3',
      'Examples',
      NULL,
      1
   ...
   (
      ...
      'GFN1LC4',
      'To be able to multiply and divde',
      'GFN1WS4',
      'Examples',
      NULL,
      1
   ...
   (
      ...
      'GFN1LC5',
      'To be able to recognize square and cube numbers.',
      'GFN1WS5',
      'Examples',
      NULL,
      1
   ...
   (
      'Index Notation',
      'GFN1LC6',
      'Introduction to Index Notation and Index laws.',
      'GFN1WS6',
      'Examples',
      NULL,
      1
   ...
   (
      'Order of Operation',
      'GFN1LC7',
      'To be able to use BIDMAS to work out calculations ',
      'GFN1WS7',
      'Examples',
      NULL,
      1
   ...
   (
      ...
      'GFN1LC8',
      'To be able to round numbers and estimate calculation',
      'GFN1WS8',
      'Examples',
      NULL,
      1
   ...
   (
      ...
      'GFN1LC9',
      'To be able to recognize factors, multiple and prime numbers',
      'GFN1WS9',
      'Examples',
      NULL,
      1
   ...
   (
      'Primefactors HCF AND LCM',
      'GFN1LC10',
      'To be able to calculate primefactors, HCF and LCM.',
      'GFN1WS10',
      'Examples',
      NULL,
      1
...
VALUES
   (
      'Number 1',
      'GFN1TDQ',
      'Number 1- Topic Diagnostic Quiz',
      'Topic',
      'diagnostic',
      TRUE,
      NULL,
...
INSERT INTO
   questionquiz (
      questionquiz_question_id,
      questionquiz_quiz_id
   )
VALUES
   (1, 1);
